...
${colors.cyan}${colors.bright}                                                                                       ${colors.reset}
${colors.cyan}${colors.bright}                            Fego Discord Mod Bot                                    ${colors.reset}
...
console.log(`${colors.dim}Starting PantherXit Moderation Discord Bot at ${new Date().toISOString()}${colors.reset}\n`);
startBot();